...
inline void write(char *&s, const unsigned &x) {
	if (x >= 10000000000000000000u)   write_char(s, (x / 10000000000000000000u ) ^ 48u);
	if (x >= 1000000000000000000u)    write_char(s, (x / 1000000000000000000u % 10u) ^ 48u);
	if (x >= 100000000000000000u)     write_char(s, (x / 100000000000000000u % 10u) ^ 48u);
	if (x >= 10000000000000000u)      write_char(s, (x / 10000000000000000u % 10u) ^ 48u);
	if (x >= 1000000000000000u)       write_char(s, (x / 1000000000000000u % 10u) ^ 48u);
	if (x >= 100000000000000u)        write_char(s, (x / 100000000000000u % 10u) ^ 48u);
	if (x >= 10000000000000u)         write_char(s, (x / 10000000000000u % 10u) ^ 48u);
	if (x >= 1000000000000u)          write_char(s, (x / 1000000000000u % 10u) ^ 48u);
	if (x >= 100000000000u)           write_char(s, (x / 100000000000u % 10u) ^ 48u);
	if (x >= 10000000000u)            write_char(s, (x / 10000000000u % 10u) ^ 48u);
	if (x >= 1000000000u)             write_char(s, (x / 1000000000u % 10u) ^ 48u);
	if (x >= 100000000u)              write_char(s, (x / 100000000u % 10u) ^ 48u);
	if (x >= 10000000u)               write_char(s, (x / 10000000u % 10u) ^ 48u);
	if (x >= 1000000u)                write_char(s, (x / 1000000u % 10u) ^ 48u);
	if (x >= 100000u)                 write_char(s, (x / 100000u % 10u) ^ 48u);
	if (x >= 10000u)                  write_char(s, (x / 10000u % 10u) ^ 48u);
	if (x >= 1000u)                   write_char(s, (x / 1000u % 10u) ^ 48u);
	if (x >= 100u)                    write_char(s, (x / 100u % 10u) ^ 48u);
	if (x >= 10u)                     write_char(s, (x / 10u % 10u) ^ 48u);
	write_char(s, (x % 10u) ^ 48u);
}
namespace bkt {
	const int null = N - 1;
	struct element {
...
void output(vector<vector<int>> &ans)
{
	...
	ftruncate(fd, n * 8 * 40);
	char*buf = (char*)mmap(NULL, n * 8 * 40, PROT_READ | PROT_WRITE, MAP_SHARED, fd, 0);
	char*mapped = buf;
	close(fd);
	write(mapped, n);
	*(mapped++) = '\n';
