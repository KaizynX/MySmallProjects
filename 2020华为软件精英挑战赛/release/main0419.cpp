...
#define write(ch) memcpy(mapped, DISC::str[*it], DISC::len[*(it)]); \
				  ...
				  *(mapped++) = ch;
	// len = 3
	it = Solve::ans[3]; ed = Solve::ans_end[3];
	while (it != ed) {
		write(',');
		write(',');
		write('\n');
	}
	it = Solve::ans[4]; ed = Solve::ans_end[4];
	while (it != ed) {
		write(',');
		write(',');
		write(',');
	...
	it = Solve::ans[5]; ed = Solve::ans_end[5];
	while (it != ed) {
		write(',');
		write(',');
		write(',');
	...
	it = Solve::ans[6]; ed = Solve::ans_end[6];
	while (it != ed) {
		write(',');
		write(',');
		write(',');
	...
	it = Solve::ans[7]; ed = Solve::ans_end[7];
	while (it != ed) {
		write(',');
		write(',');
		write(',');
