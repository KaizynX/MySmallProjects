...
#ifdef solve_repeat
	for (int i = 0; i < n; ++i) vis[i] = 0, dcnt_b[i] = 0;
	dcnt = 0;
	ans_end[3] = ans3;
	ans_end[4] = ans4;
	ans_end[5] = ans5;
...
#endif
	n = _n;
	for (int i = 0; i < n; ++i) a_begin[i] = a_end[i] = A[i], b_end[i] = b[i];
