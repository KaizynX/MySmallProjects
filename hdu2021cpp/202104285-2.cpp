/*
 * @Author: Kaizyn
 * @Date: 2021-04-28 11:01:05
 * @LastEditTime: 2021-04-28 11:02:26
 */
#include <iostream>
#include <string>
using namespace std;
...
Student1(int n1, string nam1, int n2, string nam2, int a, string ad):Student(n1, nam1), monitor(n2, nam2)
              //派生类构造函数
