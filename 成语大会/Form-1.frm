...
Private Sub Form_Load()
    ...
    '主题init
    Open App.Path & "\resources\part1\theme.txt" For Input As #1
        i = 0
        Do Until EOF(1)
...
Private Sub Label_theme_Click() '切换主题
    ...
    '打开对应主题的成语库
    Open App.Path & "\resources\part1\theme" + Replace(str(num_theme), " ", "") + ".txt" For Input As #2
        Dim i As Integer
        i = 0
        Do Until EOF(2)
