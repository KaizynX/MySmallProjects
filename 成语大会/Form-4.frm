...
Private Sub Form_Load()
    ...
    Open App.Path & "\resources\part4\answer.txt" For Input As #1
        i = 0
        Do Until EOF(1)
...
Private Sub Command_cg_Click()
    ...
    Open App.Path & "\resources\part4\data" + Replace(str(num_answer), " ", "") + ".txt" For Input As #2
        Dim i As Integer
        i = 0
        Do Until EOF(2)
