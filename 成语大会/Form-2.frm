...
Private Sub Command_hide_Click()
    If Label_cy.Visible = True Then
        Label_cy.Visible = False
        Command_hide.Caption = "显示"
    Else
        Label_cy.Visible = True
...
Private Sub Form_Load()
    ...
    Open App.Path & "\resources\part2\data.txt" For Input As #1
        i = 0
        Do Until EOF(1)
...
'    Me.Left = Screen.Width / 6
    ...
    Text_tip.Width = Me.Width * 15 / 100
    ...
    Command_tip.Left = Me.Width * 25 / 100
    '显示，隐藏
    Command_hide.Width = Me.Width * 15 / 100
    Command_hide.Height = Me.Height * 10 / 100
    Command_hide.Top = Me.Height * 50 / 100
